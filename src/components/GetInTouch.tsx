...
const EMAIL = "chauhanyogesh950@gmail.com"

const GetInTouch = () => {

  const mailtoLink = `mailto:${EMAIL}?subject=Enquiry from Portfolio Visitor`;
    ...
    <section id='get-in-touch' aria-labelledby="get-in-touch-heading">
      <div className="my-4 px-4 py-6">
        ...
        <div className="relative mt-4 max-w-lg">
          <input type="email" value={EMAIL} readOnly aria-label="My email address"
