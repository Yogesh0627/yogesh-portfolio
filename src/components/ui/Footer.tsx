    ...
    return (
        <footer className="w-full mx-auto">
            <Container
                ...
                <p className=" text-xs text-neutral-500">Built with love by Yogesh Chauhan</p>
                <div className="flex items-center justify-center gap-4">

                    <Link href="https://x.com/Yogesh0130" target="_blank" rel="noopener noreferrer">
                        <IconBrandX className=" size-4 text-neutral-500 hover:text-neutral-700 dark:text-neutral-400 dark:hover:text-neutral-200" />
                    </Link>
                    <Link href="https://www.linkedin.com/in/yogeshchauhan-dev/" target="_blank" rel="noopener noreferrer" aria-label="Visit my LinkedIn profile">
