    ...
    return (
        <form action="" method="post" onSubmit={handleSubmit} className='py-12 border-y border-neutral-100 shadow-section-inset dark:border-neutral-800 dark:shadow-section-inset my-6'>
            <div className="flex flex-col gap-5 max-w-lg mx-auto ">
                ...
                <button type='submit' className="rounded-md border border-neutral-200 bg-neutral-100 px-4 py-1.5 text-sm text-neutral-700 shadow-[0px_4px_8px_0px_var(--color-neutral-200)_inset] transition-colors hover:bg-neutral-200 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-200 dark:shadow-[0px_4px_8px_0px_var(--color-neutral-700)_inset] cursor-pointer hover:dark:bg-neutral-700">Send message</button>
            </div>
        </form>
    )
}
