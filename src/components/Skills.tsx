...
const skillGroups: SkillGroup[] = [
    ...
    },
    {
        ...
        skills: [
            ...
            { title: "Python", logo: <IconBrandPython className={iconClass} aria-hidden="true" /> },
            { title: "FastAPI", logo: <IconApi className={iconClass} aria-hidden="true" /> },
    ...
    },
    {
        ...
        skills: [
            ...
            { title: "pgvector", logo: <IconTopologyStar3 className={iconClass} aria-hidden="true" /> },
    ...
    },
    {
        ...
        skills: [
            ...
            { title: "RAG", logo: <IconFileAnalytics className={iconClass} aria-hidden="true" /> },
            { title: "OCR / Vision", logo: <IconScan className={iconClass} aria-hidden="true" /> },
        ],
    },
    {
